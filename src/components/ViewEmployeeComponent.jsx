                        ...
                        <div className="row">
                                ...
                                <div className="col-7">
                                        ...
                                        <div className = "row">
                                            ...
                                            <div className='ml-2'> { this.state.employee.flightName }</div>
                                        </div>
                                        <div className = "row">
                                            <label>Nationality: </label>
                                            <div className='ml-2'> { this.state.employee.nationality }</div>
                                        </div>
                                        <div className = "row">
                                            <label>Destination:</label>
                                            <div className='ml-2'> { this.state.employee.destination }</div>
                                        </div>
                                </div>
                        </div>
